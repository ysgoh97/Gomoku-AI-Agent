...
Plan to win: 
1. Prioritize playing near the center of the board (rows/cols 7–11). 
2. If you can make 4 in a row with an open end, play that move.
3. Try to make 3 in a row with both ends open (Live Three).
4. Try to make "Split Four"
- "Split Four" means there are four opponent pieces separated by one space, like 'xx_xx', 'xxx_x', or 'x_xxx'.

Important: If the opponent has 4 in a row with an open end, block it. If opponent has "Split Four", block immediately.
